...
endTime = time.time()
timeFile.write("Run time for experiment 2: " +
               str(endTime - startTime) + " seconds")
timeFile.write("\n")
print("Time elapsed: " + str(endTime - startTime) + " seconds")
...
endTime = time.time()
timeFile.write("Run time for experiment 3: " +
               str(endTime - startTime) + " seconds")
timeFile.write("\n")
print("Time elapsed: " + str(endTime - startTime) + " seconds")
...
endTime = time.time()
timeFile.write("Run time for experiment 4: " +
               str(endTime - startTime) + " seconds")
timeFile.write("\n")
print("Time elapsed: " + str(endTime - startTime) + " seconds")
...
endTime = time.time()
timeFile.write("Run time for experiment 5: " +
               str(endTime - startTime) + " seconds")
timeFile.write("\n")
print("Time elapsed: " + str(endTime - startTime) + " seconds")
